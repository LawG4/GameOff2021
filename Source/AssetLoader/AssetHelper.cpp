...
std::pair<SpriteSheet*, AnimatedSprite*> AnimatedSprites::hopperwalk()
{
    ...
    tex[0] = Textures::generateTexCoordinates({0, 100}, {100, 75}, {400, 75});
    tex[1] = Textures::generateTexCoordinates({100, 100}, {100, 75}, {400, 75});
    tex[2] = Textures::generateTexCoordinates({200, 100}, {100, 75}, {400, 75});
    tex[3] = Textures::generateTexCoordinates({300, 100}, {100, 75}, {400, 75});
